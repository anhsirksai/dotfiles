...
"Let jj allow you to quit insert mode
imap jj <Esc>

"make current working directory vim's directory
:set autochdir
...
" YouCompleteMe
let g:ycm_confirm_extra_conf = 0 "stop it from asking each time
"g:ycm_add_preview_to_completeopt 1
